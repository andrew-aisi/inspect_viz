...
## Function Reference {reference="sample_tool_calls"}

## Implementation

The [Sample Tool Calls](examples/inspect/sample-tool-calls/index.qmd) example demonstrates how this view was implemented using lower level plotting components.
