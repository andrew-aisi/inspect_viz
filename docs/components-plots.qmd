...
The `plot()` function has quite a few options for customizing the size, layout, axes, and other elements of plot display. Some of the more useful attribues include:
