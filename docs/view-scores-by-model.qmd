...
scores_by_model(evals, marks=[baseline(0.697)])
```
...
The [Scores with Baseline](examples/inspect/scores-by-model/index.qmd) example demonstrates how this view was implemented using lower level plotting components.
