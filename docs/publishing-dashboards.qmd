...
Here is the [Penguin Explorer](examples/general/penguins/index.qmd) example from this repository re-written as a dashboard (this is a live dashboard embedded as an iframe):
