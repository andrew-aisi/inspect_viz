...
This example summarizes the scores of a single evaluation task, gpqa_diamond, showing performance for 13 different models. Models are ordered based upon their headline score (defaulting to descending). You may add one or more baselines which
