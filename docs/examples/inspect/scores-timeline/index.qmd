...
See the documentation on the [`scores_timeline()`](../../../reference/inspect_viz.view.qmd#scores_timeline) function for details on the data it requires as well as customizing varioius aspects of the plot. If you are curious about how the plot was implemented, read on below.
