...
from inspect_viz.view.beta import eval_tool_calls

tools = Data.from_file("cybench_tools.parquet")

eval_tool_calls(tools)
```

See the documentation on the [`eval_tool_calls()`](../../../reference/inspect_viz.view.qmd#eval_tool_calls) function for details on the data it requires as well as customizing varioius aspects of the plot.  If you are curious about how the plot was implemented, read on below.
