...
from inspect_viz.view.beta import eval_scores_timeline

evals = Data.from_file("evals.parquet")
eval_scores_timeline(evals)
```

See the documentation on the [`eval_scores_timeline()`](../../../reference/inspect_viz.view.qmd#eval_scores_timeline) function for details on the data it requires as well as customizing varioius aspects of the plot. If you are curious about how the plot was implemented, read on below.
