---
title: "Sample Tool Calls"
subtitle: "Dataset: [cybench_tools.parquet](cybench_tools.parquet)"
---

This example illustrates the code behind the [`samples_tool_calls()`](../../../reference/inspect_viz.view.qmd#samples_tool_calls) pre-built view function. If you want to include this plot in your notebooks or websites you should start with that function rather than the lower-level code below.
...
1. Read tool call data (see [Data Preparation](../../../view-samples-tool-calls.qmd#data-preparation) for details).
