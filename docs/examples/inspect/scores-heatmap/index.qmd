...
This example illustrates the code behind the [`scores_heatmap()`](../../../reference/inspect_viz.view.qmd#scores_heatmap) pre-built view function. If you want to include this plot in your notebooks or websites you should start with that function rather than the lower-level code below.
