...
from inspect_viz.view.beta import eval_scores

evals = Data.from_file("evals.parquet")
eval_scores(evals)
```

See the documentation on the [`eval_scores()`](../../../reference/inspect_viz.view.qmd#eval_scores) function for details on the data it requires as well as customizing varioius aspects of the plot. 
