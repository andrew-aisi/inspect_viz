...
|  |  |
|------------------------------------|------------------------------------|
| [Evals Summary](inspect/evals-summary/index.qmd) | Bar plot summarizing eval set scores by model and task. |
| [Benchmarks](inspect/benchmarks/index.qmd) | Benchmark scores for various models, with release date on the x-axis. |
| [Tool Usage](inspect/tool-usage/index.qmd) | Visualise tool usage over a series of turns in a Cybench evaluation. |

several benchmarks against models from various organizations, with release date on the x-axis.
