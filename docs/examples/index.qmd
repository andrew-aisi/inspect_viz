...
| [Scores Heatmap](inspect/scores-heatmap/index.qmd) | Heatmap summarizing evals scores by model and task. |
...
| [Tool Calls](inspect/tool-calls/index.qmd) | Visualise tool usage over a series of turns. |
