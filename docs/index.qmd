...
Welcome to Inspect Viz, a data visualization library for [Inspect AI](https://inspect.aisi.org.uk/). Inspect Viz provides flexible tools for high quality interactive visualizations from Inspect evaluations. You can include these visualizations in any [Jupyter Notebook](https://jupyter.org/) or web publishing system that supports Jupyter widgets (e.g. [Quarto](https://quarto.org)).
...
-   [Publishing](publishing-plots.qmd) describes how to publish Inspect Viz content as standalone plots, notebooks, websites, and dashboards.
