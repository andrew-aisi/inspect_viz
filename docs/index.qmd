...
-   [Sandbox](sandbox/index.qmd) includes examples from the `inspect_viz.sandbox` module as well as information on contributing your own functions to the sandbox.