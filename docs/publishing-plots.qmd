...
| `padding` | Padding (in pixels) to add around exported plot. |
...
Unlike with `write_png()`, the exported HTML plot retains all interactive features (tooltips, filters, etc.). In some cases you might therefore also include [inputs](inputs.qmd) with your plot. For example:
